...
const CATEGORY_SLUG = "mills-and-markets" as const;
...
export default async function IndustryGuideMillsAndMarketsLeaf({
  params,
}: {
  ...
  const { default: Body } = await import(
    `@/content/guides/industry-guide/mills-and-markets/${slug}.mdx`
  );
