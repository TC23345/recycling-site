...
const CATEGORY_SLUG = "trade-and-pricing" as const;
...
export default async function IndustryGuideTradeAndPricingLeaf({
  params,
}: {
  ...
  const { default: Body } = await import(
    `@/content/guides/industry-guide/trade-and-pricing/${slug}.mdx`
  );
