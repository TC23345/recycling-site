...
const GUIDE_SLUG = "local-guide" as const;
const CATEGORY_SLUG = "regional-quirks" as const;
...
export default async function LocalGuideRegionalQuirksLeaf({
  params,
}: {
  ...
  const { default: Body } = await import(
    `@/content/guides/local-guide/regional-quirks/${slug}.mdx`
  );
