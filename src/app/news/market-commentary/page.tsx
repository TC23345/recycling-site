...
import Intro from "@/content/news/market-commentary/_intro.mdx";
import { getNewsCategory, NEWS_HUB, SITE } from "@/lib/manifest";

const category = getNewsCategory("market-commentary");
...
export default function NewsMarketCommentaryPage() {
  return (
    <PillarHub
      level={3}
