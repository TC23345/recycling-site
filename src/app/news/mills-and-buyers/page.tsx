...
import Intro from "@/content/news/mills-and-buyers/_intro.mdx";
import { getNewsCategory, NEWS_HUB, SITE } from "@/lib/manifest";

const category = getNewsCategory("mills-and-buyers");
...
export default function NewsMillsAndBuyersPage() {
  return (
    <PillarHub
      level={3}
