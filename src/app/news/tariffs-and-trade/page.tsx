...
import Intro from "@/content/news/tariffs-and-trade/_intro.mdx";
import { getNewsCategory, NEWS_HUB, SITE } from "@/lib/manifest";

const category = getNewsCategory("tariffs-and-trade");
...
export default function NewsTariffsAndTradePage() {
  return (
    <PillarHub
      level={3}
