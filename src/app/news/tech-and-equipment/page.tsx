...
import Intro from "@/content/news/tech-and-equipment/_intro.mdx";
import { getNewsCategory, NEWS_HUB, SITE } from "@/lib/manifest";

const category = getNewsCategory("tech-and-equipment");
...
export default function NewsTechAndEquipmentPage() {
  return (
    <PillarHub
      level={3}
