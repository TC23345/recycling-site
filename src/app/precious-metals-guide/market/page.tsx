...
import Intro from "@/content/guides/precious-metals-guide/market/_intro.mdx";
import { getCategory, getGuide, leavesByCategory, SITE } from "@/lib/manifest";

const guide = getGuide("precious-metals-guide");
const category = getCategory("precious-metals-guide", "market");
...
export default function PreciousMetalsMarketHub() {
  return (
    <PillarHub
      level={3}
      ...
      description={category.description}
      href={category.href}
      childGuideLeaves={leavesByCategory("precious-metals-guide", "market")}
      crumbs={[
