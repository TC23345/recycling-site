...
const CATEGORY_SLUG = "metal-recycling" as const;
...
export default async function RecyclingGuideMetalRecyclingLeaf({
  params,
}: {
  ...
  const { default: Body } = await import(
    `@/content/guides/recycling-guide/metal-recycling/${slug}.mdx`
  );
