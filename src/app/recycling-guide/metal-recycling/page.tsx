...
import Intro from "@/content/guides/recycling-guide/metal-recycling/_intro.mdx";
import { getCategory, getGuide, leavesByCategory, SITE } from "@/lib/manifest";

const guide = getGuide("recycling-guide");
const category = getCategory("recycling-guide", "metal-recycling");
...
export default function RecyclingGuideMetalRecyclingHub() {
  return (
    <PillarHub
      level={3}
      ...
      description={category.description}
      href={category.href}
      childGuideLeaves={leavesByCategory("recycling-guide", "metal-recycling")}
      crumbs={[
