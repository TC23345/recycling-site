...
import Intro from "@/content/guides/scrap-guide/basics/_intro.mdx";
import { getCategory, getGuide, leavesByCategory, SITE } from "@/lib/manifest";

const guide = getGuide("scrap-guide");
const category = getCategory("scrap-guide", "basics");
...
export default function ScrapGuideBasicsHub() {
  return (
    <PillarHub
      level={3}
      ...
      description={category.description}
      href={category.href}
      childGuideLeaves={leavesByCategory("scrap-guide", "basics")}
      crumbs={[
