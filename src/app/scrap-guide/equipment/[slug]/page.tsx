...
const GUIDE_SLUG = "scrap-guide" as const;
const CATEGORY_SLUG = "equipment" as const;
...
export default async function ScrapGuideEquipmentLeaf({
  params,
}: {
  ...
  const { default: Body } = await import(
    `@/content/guides/scrap-guide/equipment/${slug}.mdx`
  );
