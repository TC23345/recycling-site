...
import Intro from "@/content/guides/selling-guide/preparation/_intro.mdx";
import { getCategory, getGuide, leavesByCategory, SITE } from "@/lib/manifest";

const guide = getGuide("selling-guide");
const category = getCategory("selling-guide", "preparation");
...
export default function SellingGuidePreparationHub() {
  return (
    <PillarHub
      level={3}
      ...
      description={category.description}
      href={category.href}
      childGuideLeaves={leavesByCategory("selling-guide", "preparation")}
      crumbs={[
