...
import Intro from "@/content/guides/selling-guide/pricing/_intro.mdx";
import { getCategory, getGuide, leavesByCategory, SITE } from "@/lib/manifest";

const guide = getGuide("selling-guide");
const category = getCategory("selling-guide", "pricing");
...
export default function SellingGuidePricingHub() {
  return (
    <PillarHub
      level={3}
      ...
      description={category.description}
      href={category.href}
      childGuideLeaves={leavesByCategory("selling-guide", "pricing")}
      crumbs={[
