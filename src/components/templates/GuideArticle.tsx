...
export default function GuideArticle({ page, crumbs, clusterSlug, body }: GuideArticleProps) {
  const articleJsonLd = {
  ...
  return (
    <>
      <PageHero eyebrow="Guide" title={page.title} description={page.description} />
