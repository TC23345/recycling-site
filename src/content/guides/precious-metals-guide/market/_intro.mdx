...
This page is the *why* behind the chart — what moves precious-metal prices, how the LBMA fixing translates that into the headline refiners reference, and why published spot almost never matches what you'll get paid. The [precious-metals basics page](/precious-metals-guide/basics) covers karat math and troy-ounce conventions, and the [grades and assays guide](/precious-metals-guide/grades) covers how a refiner values a mixed lot.
...
You don't need TradingView fluency. Open Kitco, BullionVault, or the [live gold-price chart](/gold-price), set the window to **30 days**, and look at three things: the trend (up, down, sideways), the range (high vs. low), and any single-day spikes that look out of pattern.
