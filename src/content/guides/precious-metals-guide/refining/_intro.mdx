...
Risk is manageable: pick a known operator, ship insured to the lot's value, document everything before it leaves the house. The [selling guide](/selling-guide) walks through documentation in more detail.
...
- **Track-record names** — Garfield Refining, Midwest Refineries, NPMEX, and Provident Metals are historically reliable mail-in players. Not personal endorsements; do your own diligence each time. Regional refiners are listed in the [vendors directory](/industry-guide/vendors).
...
If your lot includes anything with numismatic value above melt — pre-1933 US gold, MS-graded coins, key dates — a coin shop is the right venue and a refiner is wrong. Don't melt anything with a collector premium. For unit conversions and the magnet/acid quick-check, see [the basics page](/precious-metals-guide/basics) and the [purity rundown](/precious-metals-guide/grades).
...
To find vetted buyers without trawling BBB from scratch, the [near-me directory](/local-guide/near-me) is a starting point. Call two or three before you drive — payout factors on the same lot can vary 4–6 points across shops in the same city.
