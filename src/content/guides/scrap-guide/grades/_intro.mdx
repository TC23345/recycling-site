...
Real per-pound numbers and grade-by-grade descriptions live on the leaf pages — [Copper & Wire](/scrap-guide/grades/copper-and-wire) is the deepest of them.
...
- [Copper & Wire: Grades, Prices, and What Yards Want](/scrap-guide/grades/copper-and-wire) — the copper grade ladder in detail
