...
> **Page brief.** Target keyword: `scrap metal tariffs news`. Audience: exporters, brokers, mill procurement, and yard operators on the coasts. Funnel stage: awareness/consideration. The page should answer: how do current tariffs and export-control rules affect U.S. scrap flows and pricing, and what's changing.
...
- **Policy explainer** — 1,000–1,800 words on a tariff or trade rule with operational implications
- **Petition tracker** — ITC anti-dumping case progress
- **Export-data read** — quarterly note on Census trade data movements
- **Rate change** — short bulletin on a duty schedule update
