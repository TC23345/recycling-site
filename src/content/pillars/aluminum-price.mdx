...
Spot price is the wholesale benchmark. For aluminum, it's set on the **LME** (the London Metal Exchange — the global reference for non-ferrous metals) and quoted in **USD per metric tonne**. The ticker above does the per-pound conversion for you, so you don't have to translate tonnes into pounds in your head. When a financial-news headline says "aluminum is up 3%," they mean the LME three-month contract.
...
Stack those together and the typical clean-sheet load lands at **65–75% of LME spot**, not the 85–92% you'd see for bare-bright copper. Aluminum is a structurally less-tight market than copper, and [the scrap-discount math at the yard](/scrap-guide/yards/scrap-metal-prices) reflects that. A worked example helps:
...
For the broader pricing context — how scrap-metal pricing moves across grades — the [scrap metal prices reference page](/scrap-guide/yards/scrap-metal-prices) has the comparable view across non-ferrous and ferrous. To find a yard near you to compare boards, the [scrap-yards directory](/local-guide/near-me/scrap-yards-near-me) is a starting point — calling two or three before driving is almost always worth it for aluminum, where the spread between yards on the same load can be 20%+.
...
For seller-side pricing literacy — the rest of the cash-and-tax considerations — the [scrap pricing literacy guide](/selling-guide/pricing) covers what reputable yards expect from a first-time seller. If you're moving enough volume that you're considering a formal buyer relationship, the [OmniSource buyer profile](/industry-guide/vendors/omnisource) is a representative profile of one of the larger US-based industrial buyers; the same patterns apply at most major chains and many independents.
...
Substitute the live ticker number above for the example $1.20 to get current values. The LME quote you'll see on industry sites is in USD per metric tonne; the per-pound number is roughly the tonne price divided by ~2,205. The [aluminum price per pound leaf](/aluminum-price/aluminum-price-per-pound) focuses on the per-pound number alone with current cash-payout context.

## Frequently asked questions

<FaqItem q="How much is a pound of aluminum worth right now?">
...
<FaqItem q="How much is a pound of aluminum cans worth?">
...
<FaqItem q="Why is the yard's price so much lower than the LME spot price I see online?">
...
<FaqItem q="Is now a good time to sell aluminum scrap?">
...
<FaqItem q="What's the difference between cast and sheet aluminum, and why does it matter so much?">
...
For a per-pound focus rather than a grade-by-grade view, the [aluminum price per pound leaf](/aluminum-price/aluminum-price-per-pound) is the same data with a tighter lens. The [aluminum scrap price page](/aluminum-price/aluminum-scrap-price) goes deeper on grade-level pricing and yard mechanics. If you're shopping multiple metals, the other pricing pillars cover [copper prices](/copper-price), [brass prices](/brass-price), [stainless steel prices](/stainless-steel-price), and the precious metals via [live gold pricing](/gold-price) and [silver pricing](/silver-price). For local-market context, [scrap metal prices near you](/local-guide/near-me/scrap-metal-prices-near-me) helps you sanity-check what your regional yards are quoting, and the broader [scrap metal recycling overview](/recycling-guide/metal-recycling/scrap-metal-recycling) frames where aluminum fits in the wider non-ferrous market.

For the official global benchmark, the [LME aluminium page](https://www.lme.com/Metals/Non-ferrous/LME-Aluminium) publishes daily official prices and stock levels.
