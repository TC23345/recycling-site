...
The honest answer: copper moves brass prices, and almost nothing else does meaningfully on a week-to-week basis. Brass isn't traded as a standalone commodity, so there's no "brass demand" reading on a Bloomberg terminal — only the underlying inputs.
