...
The ticker above derives a brass price from live copper futures using a typical Cu/Zn mass-blend ratio of roughly 0.62. Most pages quoting a "brass price" online either pull from a regional yard's posted board or quote a single industrial buyer. Both are valid, but neither tells you the underlying math. If copper reads $4.20/lb on the COMEX tape, the derived brass spot lands near $2.60/lb — and your local yard will pay somewhere in the $1.90–$2.70/lb range for clean yellow brass after their grade and contamination discounts.

The gap between that derived spot and what a yard pays you is what the rest of this page works through. For a broader [scrap metal pricing reference](/scrap-guide/yards/scrap-metal-prices) tracking the same patterns across copper, aluminum, and steel, that cross-metal page is the next stop.
...
Numbers above are typical industry ranges — your local market will run tighter or looser. The big lesson: yellow brass typically pays **62–80% of copper spot**, and red brass closer to **75–85%**, depending on cleanliness and the yard's appetite for the grade that day. For deeper grade-by-grade context, the [copper and wire scrap-grading guide](/scrap-guide/grades/copper-and-wire) covers the closely-related copper ladder that brass derives from.
...
For a regional sanity check on what your local yards are quoting, [start with the scrap-yards directory](/local-guide/near-me/scrap-yards-near-me) and call two or three before driving. For a broader comparable view, the [scrap-metal-prices-near-you reference](/local-guide/near-me/scrap-metal-prices-near-me) tracks regional patterns across grades.
...
- **Check whether the yard separates shells.** Some major buyers maintain a dedicated shell-buying counter with separate paperwork; others lump shells into yellow brass. The shell counter often pays better. The [OmniSource buyer profile](/industry-guide/vendors/omnisource) is a representative writeup of one of the larger US-based industrial chains; the same patterns apply at most major buyers and many independents.

For the rest of the seller-side pricing literacy — taxes, payment thresholds, and what reputable yards expect from a first-time seller — the [scrap pricing literacy guide](/selling-guide/pricing) is the deeper read. If you're moving enough volume that you're considering specifically what copper-leaf grades pay, the [copper scrap price detail](/copper-price/copper-scrap-price) and [copper per pound](/copper-price/copper-per-pound) pages cover the cousin metal that drives brass economics.
...
Look at the 30-day chart at the top of this page, and look at copper's 30-day chart on the [copper-price page](/copper-price). If copper is up 8% or more over the past month, the macro tape is favorable for brass too — and your pile just appreciated. If copper is flat or down, holding rarely costs much (brass doesn't spoil). Don't try to time the bottom; aim for "good enough" and move the load.
