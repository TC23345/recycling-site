...
The number above is the **spot** price for one troy ounce of pure (.9999) gold, in USD — the LBMA gold fix set twice daily in London. Spot is the wholesale benchmark, the reference number bullion banks and refiners trade against. It's almost never what you'll get for jewelry, dental scrap, or inherited coins: refiners take a cut for assay, melt, and risk, and they buy by **karat purity** plus weight.

If you're sorting through a parent's jewelry box or weighing whether to part with a wedding band, the math below is the same one any reputable buyer uses. Walking in knowing it is the difference between a fair payout and a polite fleecing.
